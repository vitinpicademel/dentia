...
const replacements = [
    ...
    { search: /Agendar Consulta/g, replace: 'Agendar Avaliação' },
    { search: /Agende sua Consulta/g, replace: 'Agende sua Avaliação' },
    { search: /Agende uma Consulta/g, replace: 'Agende uma Avaliação' },
    { search: /Booking Appointment/g, replace: 'Agendar Avaliação' },
    { search: /Book Appointment/g, replace: 'Agendar Avaliação' },
